...
struct MoroGamesWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: MoroGamesWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> MoroGamesWebCoordinator {
        MoroGamesWebCoordinator { [weak loader] status in
