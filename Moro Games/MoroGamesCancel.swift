...
protocol WebLoadable: AnyObject {
    var state: MoroGamesWebStatus { get set }
...
final class MoroGamesWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: MoroGamesWebStatus = .standby
...
extension MoroGamesWebLoader: WKNavigationDelegate {
