...
enum MoroGamesWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: MoroGamesWebStatus) -> Bool {
        switch (self, other) {
...
extension MoroGamesWebStatus {
    static func == (lhs: MoroGamesWebStatus, rhs: MoroGamesWebStatus) -> Bool {
